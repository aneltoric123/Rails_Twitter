...
class RetweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retweet" do
    assert_difference("Retweet.count") do
      post retweets_url, params: { retweet: { retweet_number: @retweet.retweet_number, tweet_id: @retweet.tweet_id, user_id: @retweet.user_id } }
    end
  ...
  test "should update retweet" do
    patch retweet_url(@retweet), params: { retweet: { retweet_number: @retweet.retweet_number, tweet_id: @retweet.tweet_id, user_id: @retweet.user_id } }
